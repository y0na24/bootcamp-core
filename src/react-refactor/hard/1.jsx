...
export function Button({ size, label, color, onClick, disabled, isLoading }) {
  ...
  return (
    <div className="key">
      ...
      <div className="key__buttons">
        ...
        <Button size="s" color="danger" label="Удалить" onClick={removeKey} />
      </div>
    </div>
  );
}
...
// Просто заглушки. Их не надо ревьюить
